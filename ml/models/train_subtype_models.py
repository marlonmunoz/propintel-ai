...
def evaluation_predictions(y_test_log, y_pred_log):
...
def train_subtype_model(df: pd.DataFrame, subtype_name: str, building_classes: list[str]):
    ...
    print(df["building_class"].value_counts().to_string()) # ==== DEBUG PRINT ====
    ...
    mae, rmse, r2 = evaluation_predictions(y_test, y_pred)
